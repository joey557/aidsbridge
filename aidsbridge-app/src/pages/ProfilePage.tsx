...
export default function VerticalTabs() {
  ...
  const updateCredentials = async(accountId: string | undefined) => {
    ...
    try {
      const response = await fetch(`http://localhost:3000/aidsbridge/user/update/${accountId}`, {
        method: 'PUT',
        headers: {
    ...
    <ThemeProvider theme={theme}>
      <div style={{
        ...
        <div style={{
          ...
          <Box sx={{ flexGrow: 1, display: 'flex', height: 300, marginLeft: '250px' }}>
            <Tabs
            ...
            <TabPanel value={value} index={0}>
              ...
              <TextField
                ...
                margin="normal"
              />
              <Button onClick={() => updateCredentials(user?.accountId)} variant="contained" sx={{ width: '100%' }}>
                Update Credentials
              </Button>
